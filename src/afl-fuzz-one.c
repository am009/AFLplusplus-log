...
u8 fuzz_one_original(afl_state_t *afl) {
  ...
  fuzzerlog_chances();
  fuzzerlog_reset_current_seed_name();
  fuzzerlog_reset_chances();
  fuzzerlog_set_current_seed_name(afl->queue_cur->fname);
...
#define FLIP_BIT(_ar, _b)                     \
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    fuzzerlog_add_mutator_name("bitflip_1");
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("bitflip_2");
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("bitflip_4");
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("bitflip_8");
  ...
  for (i = 0; i < len - 1; ++i) {
    ...
    *(u16 *)(out_buf + i) ^= 0xFFFF;
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("bitflip_16");
  ...
  for (i = 0; i < len - 3; ++i) {
    ...
    *(u32 *)(out_buf + i) ^= 0xFFFFFFFF;
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("bitflip_32");
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 1; j <= ARITH_MAX; ++j) {
      ...
      if (!could_be_bitflip(r)) {
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_8_add");
      ...
      if (!could_be_bitflip(r)) {
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_8_minus");
    ...
    for (j = 1; j <= ARITH_MAX; ++j) {
      ...
      if ((orig & 0xff) + j > 0xff && !could_be_bitflip(r1)) {
        ...
        *(u16 *)(out_buf + i) = orig + j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_16_le_add");
      ...
      if ((orig & 0xff) < j && !could_be_bitflip(r2)) {
        ...
        *(u16 *)(out_buf + i) = orig - j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_16_le_minus");
      ...
      if ((orig >> 8) + j > 0xff && !could_be_bitflip(r3)) {
        ...
        *(u16 *)(out_buf + i) = SWAP16(SWAP16(orig) + j);
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_16_be_add");
      ...
      if ((orig >> 8) < j && !could_be_bitflip(r4)) {
        ...
        *(u16 *)(out_buf + i) = SWAP16(SWAP16(orig) - j);
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_16_be_minus");
    ...
    for (j = 1; j <= ARITH_MAX; ++j) {
      ...
      if ((orig & 0xffff) + j > 0xffff && !could_be_bitflip(r1)) {
        ...
        *(u32 *)(out_buf + i) = orig + j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_32_le_add");
      ...
      if ((orig & 0xffff) < (u32)j && !could_be_bitflip(r2)) {
        ...
        *(u32 *)(out_buf + i) = orig - j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_32_le_minus");
      ...
      if ((SWAP32(orig) & 0xffff) + j > 0xffff && !could_be_bitflip(r3)) {
        ...
        *(u32 *)(out_buf + i) = SWAP32(SWAP32(orig) + j);
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_32_be_add");
      ...
      if ((SWAP32(orig) & 0xffff) < (u32)j && !could_be_bitflip(r4)) {
        ...
        *(u32 *)(out_buf + i) = SWAP32(SWAP32(orig) - j);
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("arith_32_be_minus");
...
skip_arith:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < (u32)sizeof(interesting_8); ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("interesting_8");
    ...
    for (j = 0; j < sizeof(interesting_16) / 2; ++j) {
      ...
      if (!could_be_bitflip(orig ^ (u16)interesting_16[j]) &&
        ...
        *(u16 *)(out_buf + i) = interesting_16[j];
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("interesting_16_le");
      ...
      if ((u16)interesting_16[j] != SWAP16(interesting_16[j]) &&
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("interesting_16_be");
    ...
    for (j = 0; j < sizeof(interesting_32) / 4; ++j) {
      ...
      if (!could_be_bitflip(orig ^ (u32)interesting_32[j]) &&
        ...
        *(u32 *)(out_buf + i) = interesting_32[j];
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("interesting_32_le");
      ...
      if ((u32)interesting_32[j] != SWAP32(interesting_32[j]) &&
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("interesting_32_be");
...
skip_interest:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < afl->extras_cnt; ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("extra_rep");
  ...
  for (i = 0; i <= (u32)len; ++i) {
    ...
    for (j = 0; j < afl->extras_cnt; ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("extra_ins");
...
skip_user_extras:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < min_extra_len; ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("auto_extra_overwrite");
  ...
  for (i = 0; i <= (u32)len; ++i) {
    ...
    for (j = 0; j < afl->a_extras_cnt; ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("auto_extra_insert");
    ...
    retry_havoc_step: {
      ...
      switch (mutation_array[r]) {
        ...
        case MUT_FLIPBIT: {
          ...
          fuzzerlog_add_mutator_name("havoc_bitflip");
        ...
        case MUT_INTERESTING16: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_interesting_16_le");
#ifdef INTROSPECTION
        ...
        case MUT_INTERESTING16BE: {
          ...
          item = rand_below(afl, sizeof(interesting_16) >> 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_interesting_16_be");
#ifdef INTROSPECTION
        ...
        case MUT_INTERESTING32: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_interesting_32_le");
#ifdef INTROSPECTION
        ...
        case MUT_INTERESTING32BE: {
          ...
          item = rand_below(afl, sizeof(interesting_32) >> 2);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_interesting_32_be");
#ifdef INTROSPECTION
        ...
        case MUT_ARITH16_: {
          ...
          item = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_sub_16_le");
#ifdef INTROSPECTION
        ...
        case MUT_ARITH16BE_: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_sub_16_be");
        ...
        case MUT_ARITH16: {
          ...
          item = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_add_16_le");
        ...
        case MUT_ARITH16BE: {
          ...
          u16 num = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_add_16_be");
        ...
        case MUT_ARITH32_: {
          ...
          item = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_sub_32_le");
        ...
        case MUT_ARITH32BE_: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_sub_32_be");
        ...
        case MUT_ARITH32: {
          ...
          item = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_add_32_le");
        ...
        case MUT_ARITH32BE: {
          ...
          u32 num = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_arith_add_32_be");
        ...
        case MUT_RAND8: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_rnd_8");
#ifdef INTROSPECTION
        ...
        case MUT_CLONE_COPY: {
          ...
          if (likely(temp_len + HAVOC_BLK_XL < MAX_FILE)) {
            ...
            /* FUZZERLOG: add mutator name */
            fuzzerlog_add_mutator_name("havoc_clone");
#ifdef INTROSPECTION
        ...
        case MUT_CLONE_FIXED: {
          ...
          if (likely(temp_len + HAVOC_BLK_XL < MAX_FILE)) {
            ...
            /* FUZZERLOG: add mutator name */
            fuzzerlog_add_mutator_name("havoc_ins");
#ifdef INTROSPECTION
            snprintf(afl->m_tmp, sizeof(afl->m_tmp), " CLONE-%s_%u_%u_%u",
        ...
        case MUT_OVERWRITE_COPY: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_rep");
#ifdef INTROSPECTION
        ...
        case MUT_OVERWRITE_FIXED: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_rep_fixed");
#ifdef INTROSPECTION
        ...
        case MUT_SWITCH: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_switch");
#ifdef INTROSPECTION
        ...
        case MUT_DEL: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_del");
        ...
        case MUT_SHUFFLE: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_shuffle");
        ...
        case MUT_DELONE: {
          ...
          u32 del_from = rand_below(afl, temp_len - del_len + 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_delone");
        ...
        case MUT_INSERTONE: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_insertone");
#ifdef INTROSPECTION
        ...
        case MUT_ASCIINUM: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_asciinum");
        ...
        case MUT_INSERTASCIINUM: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_insertasciinum");
#ifdef INTROSPECTION
        ...
        case MUT_EXTRA_OVERWRITE: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_extra_rep");
#ifdef INTROSPECTION
        ...
        case MUT_EXTRA_INSERT: {
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_extra_ins");
#ifdef INTROSPECTION
        ...
        case MUT_AUTO_EXTRA_OVERWRITE: {
          ...
          u32 insert_at = rand_below(afl, temp_len - extra_len + 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_auto_extra_rep");
#ifdef INTROSPECTION
          snprintf(afl->m_tmp, sizeof(afl->m_tmp),
        ...
        case MUT_AUTO_EXTRA_INSERT: {
          ...
          u32 insert_at = rand_below(afl, temp_len + 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_auto_extra_ins");
#ifdef INTROSPECTION
        ...
        case MUT_SPLICE_OVERWRITE: {
          ...
          fuzzerlog_set_splice_seed_name(target->fname);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_splice_overwrite");
#ifdef INTROSPECTION
          snprintf(afl->m_tmp, sizeof(afl->m_tmp),
        ...
        case MUT_SPLICE_INSERT: {
          ...
          fuzzerlog_set_splice_seed_name(target->fname);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("havoc_splice_insert");
#ifdef INTROSPECTION
...
#define FLIP_BIT(_ar, _b)                     \
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_1");
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    FLIP_BIT(out_buf, afl->stage_cur + 1);
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_2");
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_4");
...
#define EFF_SPAN_ALEN(_p, _l) (EFF_APOS((_p) + (_l) - 1) - EFF_APOS(_p) + 1)
  ...
  for (afl->stage_cur = 0; afl->stage_cur < afl->stage_max; ++afl->stage_cur) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_8");
  ...
  for (i = 0; i < len - 1; ++i) {
    ...
    *(u16 *)(out_buf + i) ^= 0xFFFF;
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_16");
  ...
  for (i = 0; i < len - 3; ++i) {
    ...
    *(u32 *)(out_buf + i) ^= 0xFFFFFFFF;
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_bitflip_32");
...
skip_bitflip:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_arith_8_add");
    ...
    /* FUZZERLOG: log mutator name */
    fuzzerlog_add_mutator_name("mopt_arith_8_minus");
    ...
    for (j = 1; j <= ARITH_MAX; ++j) {
      ...
      if ((orig & 0xff) + j > 0xff && !could_be_bitflip(r1)) {
        ...
        *(u16 *)(out_buf + i) = orig + j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_arith_16_le_add");
      ...
      if ((orig & 0xff) < j && !could_be_bitflip(r2)) {
        ...
        *(u16 *)(out_buf + i) = orig - j;
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_arith_16_le_minus");
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_16_be_add");
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_16_be_minus");
  ...
  for (i = 0; i < len - 3; ++i) {
    ...
    for (j = 1; j <= ARITH_MAX; ++j) {
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_32_le_add");
      ...
      if ((orig & 0xffff) < j && !could_be_bitflip(r2)) {
        ...
        *(u32 *)(out_buf + i) = orig - j;
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_32_le_minus");
      ...
      if ((SWAP32(orig) & 0xffff) + j > 0xffff && !could_be_bitflip(r3)) {
        ...
        *(u32 *)(out_buf + i) = SWAP32(SWAP32(orig) + j);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_32_be_add");
      ...
      if ((SWAP32(orig) & 0xffff) < j && !could_be_bitflip(r4)) {
        ...
        *(u32 *)(out_buf + i) = SWAP32(SWAP32(orig) - j);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_arith_32_be_minus");
...
skip_arith:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < sizeof(interesting_8); ++j) {
      ...
      out_buf[i] = interesting_8[j];
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_interesting_8");
#ifdef INTROSPECTION
      snprintf(afl->mutation, sizeof(afl->mutation),
    ...
    for (j = 0; j < sizeof(interesting_16) / 2; ++j) {
      ...
      if (!could_be_bitflip(orig ^ (u16)interesting_16[j]) &&
        ...
        *(u16 *)(out_buf + i) = interesting_16[j];
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_interesting_16_le");
#ifdef INTROSPECTION
        snprintf(afl->mutation, sizeof(afl->mutation),
      ...
      if ((u16)interesting_16[j] != SWAP16(interesting_16[j]) &&
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_interesting_16_be");
  ...
  for (i = 0; i < len - 3; ++i) {
    ...
    for (j = 0; j < sizeof(interesting_32) / 4; ++j) {
      ...
      if (!could_be_bitflip(orig ^ (u32)interesting_32[j]) &&
        ...
        *(u32 *)(out_buf + i) = interesting_32[j];
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_interesting_32_le");
#ifdef INTROSPECTION
        snprintf(afl->mutation, sizeof(afl->mutation),
      ...
      if ((u32)interesting_32[j] != SWAP32(interesting_32[j]) &&
        ...
        afl->stage_val_type = STAGE_VAL_BE;
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_interesting_32_be");
...
skip_interest:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < afl->extras_cnt; ++j) {
      ...
      memcpy(out_buf + i, afl->extras[j].data, last_len);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_extra_rep");
#ifdef INTROSPECTION
      snprintf(afl->mutation, sizeof(afl->mutation),
  ...
  for (i = 0; i <= (u32)len; ++i) {
    ...
    for (j = 0; j < afl->extras_cnt; ++j) {
      ...
      memcpy(ex_tmp + i + afl->extras[j].len, out_buf + i, len - i);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_extra_ins");
#ifdef INTROSPECTION
      snprintf(afl->mutation, sizeof(afl->mutation),
...
skip_user_extras:
  ...
  for (i = 0; i < (u32)len; ++i) {
    ...
    for (j = 0; j < min_extra_len; ++j) {
      ...
      memcpy(out_buf + i, afl->a_extras[j].data, last_len);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_auto_extra_rep");
  ...
  for (i = 0; i <= (u32)len; ++i) {
    ...
    for (j = 0; j < afl->a_extras_cnt; ++j) {
      ...
      memcpy(ex_tmp + i + afl->a_extras[j].len, out_buf + i, len - i);
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_auto_extra_insert");
  ...
  // for (; afl->swarm_now < swarm_num; ++afl->swarm_now)
  {
    ...
    havoc_stage_puppet:
      ...
      if (!splice_cycle) {
        ...
        /* FUZZERLOG: log splice operator */
        fuzzerlog_add_mutator_name("mopt_splice");
        ...
        for (i = 0; i < use_stacking; ++i) {
          ...
          switch (r = (select_algorithm(afl, r_max))) {
            ...
            case 0:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip1");
#ifdef INTROSPECTION
            ...
            case 1:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip2");
#ifdef INTROSPECTION
            ...
            case 2:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip4");
#ifdef INTROSPECTION
            ...
            case 3:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip8");
#ifdef INTROSPECTION
            ...
            case 4:
              ...
              *(u16 *)(out_buf + rand_below(afl, temp_len - 1)) ^= 0xFFFF;
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip16");
#ifdef INTROSPECTION
            ...
            case 5:
              ...
              *(u32 *)(out_buf + rand_below(afl, temp_len - 3)) ^= 0xFFFFFFFF;
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_bitflip32");
#ifdef INTROSPECTION
            ...
            case 6:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_arith8");
#ifdef INTROSPECTION
            ...
            case 7:
              ...
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_arith_sub_16_le");
#ifdef INTROSPECTION
                ...
                u16 num = 1 + rand_below(afl, ARITH_MAX);
              /* FUZZERLOG: add mutator name */
              fuzzerlog_add_mutator_name("mopt_havoc_arith_sub_16_be");
#ifdef INTROSPECTION
              ...
              if (rand_below(afl, 2)) {
                ...
                u32 pos = rand_below(afl, temp_len - 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_add_16_le");
#ifdef INTROSPECTION
                snprintf(afl->m_tmp, sizeof(afl->m_tmp), " ARITH16+-%u", pos);
                strcat(afl->mutation, afl->m_tmp);
#endif
                *(u16 *)(out_buf + pos) += 1 + rand_below(afl, ARITH_MAX);
                ...
                u16 num = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_add_16_be");
#ifdef INTROSPECTION
                snprintf(afl->m_tmp, sizeof(afl->m_tmp), " ARITH16BE+-%u-%u",
                         pos, num);
                strcat(afl->mutation, afl->m_tmp);
            ...
            case 8:
              ...
              if (rand_below(afl, 2)) {
                ...
                u32 pos = rand_below(afl, temp_len - 3);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_sub_32_le");
#ifdef INTROSPECTION
                ...
                *(u32 *)(out_buf + pos) -= 1 + rand_below(afl, ARITH_MAX);
                ...
                u32 num = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_sub_32_be");
#ifdef INTROSPECTION
              ...
              if (rand_below(afl, 2)) {
                ...
                u32 pos = rand_below(afl, temp_len - 3);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_add_32_le");
#ifdef INTROSPECTION
                ...
                *(u32 *)(out_buf + pos) += 1 + rand_below(afl, ARITH_MAX);
                ...
                u32 num = 1 + rand_below(afl, ARITH_MAX);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_arith_add_32_be");
      ...
      /* FUZZERLOG: log mutator name */
      fuzzerlog_add_mutator_name("mopt_havoc_interesting_8");
#ifdef INTROSPECTION
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_havoc_interesting_16_be");
            ...
            case 11:
              ...
              if (rand_below(afl, 2)) {
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_havoc_interesting_32_le");
#ifdef INTROSPECTION
        ...
        /* FUZZERLOG: log mutator name */
        fuzzerlog_add_mutator_name("mopt_havoc_interesting_32_be");
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_rnd_8");
#ifdef INTROSPECTION
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_del");
            ...
            /* FUZZERLOG: add mutator name */
            fuzzerlog_add_mutator_name("mopt_havoc_clone");
#ifdef INTROSPECTION
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_rep");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_rep_fixed");
#ifdef INTROSPECTION
                snprintf(afl->m_tmp, sizeof(afl->m_tmp),
            ...
            default: {
              ...
              if (r == 0 && (afl->extras_cnt || afl->a_extras_cnt)) {
                ...
                if (!afl->extras_cnt ||
                  ...
                  u32 insert_at = rand_below(afl, temp_len - extra_len + 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_auto_extra_rep");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
                  ...
                  u32 insert_at = rand_below(afl, temp_len - extra_len + 1);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_extra_rep");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_auto_extra_ins");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
          ...
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_extra_ins");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
          ...
          fuzzerlog_set_splice_seed_name(target->fname);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_splice_overwrite");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
          ...
          fuzzerlog_set_splice_seed_name(target->fname);
          /* FUZZERLOG: add mutator name */
          fuzzerlog_add_mutator_name("mopt_havoc_splice_insert");
#ifdef INTROSPECTION
                  snprintf(afl->m_tmp, sizeof(afl->m_tmp),
